def test_090_휴대폰결제(self):
    try:
        ...
        if TCFG.environment == 'PRD':
            self.interact_by_id('com.amorepacific.amorepacificmall:id/search_edit_text', send_keys_msg='칫솔')  # 텍스트 입력
        ...
        # 옵션 상품일 경우 첫 번째 상품 선택
        try:
            self.interact_by_xpath('//android.widget.Button[@text="상품을 선택해주세요"]')
            self.interact_by_xpath('(//*[contains(@text,"0원")])[1]')
        except:
            pass
